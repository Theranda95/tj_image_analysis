...
results_dir = output_base_dir + "/251030_cyt_mrtfb_int_res/"; // Path to making the directory
        ...
        for (j = 0; j < roiFiles.length; j++) {
            ...
            if (endsWith(roiFile, ".zip")) {
                ...
                if (tifMatch == roiMatch) {
                	...
                	saveAs("Results", results_dir + tifMatch + "_nuc_results.csv");
