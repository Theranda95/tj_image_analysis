...
path = "/Users/therandajashari/Documents/experiments_2026/260112_wt_characterization_2/260223_myh3_myh8_analysis/260219_mix1_myh3488_mf20555_myh8647.lif";
...
// Dialog for series range selection
...
output_base_dir = "/Users/therandajashari/Documents/experiments_2026/260112_wt_characterization_2/260223_myh3_myh8_analysis/";

// Create output subdirectories
mf20_maxproj_dir = output_base_dir + "260223_mf20_maxproj/";
File.makeDirectory(mf20_maxproj_dir);

mf20_subs_masks_dir = output_base_dir + "260223_mf20_subs_masks/";
File.makeDirectory(mf20_subs_masks_dir);

mf20_sumproj_dir = output_base_dir + "260223_mf20_sumproj/";
File.makeDirectory(mf20_sumproj_dir);

mf20_rois_dir = output_base_dir + "260223_mf20_rois/";
File.makeDirectory(mf20_rois_dir);

myh3_sumproj_dir = output_base_dir + "260223_myh3_sumproj/";
File.makeDirectory(myh3_sumproj_dir);

myh8_maxproj_dir = output_base_dir + "260223_myh8_maxproj/";
File.makeDirectory(myh8_maxproj_dir);

myh8_masks_dir = output_base_dir + "260223_myh8_masks/";
File.makeDirectory(myh8_masks_dir);

myh8_sumproj_dir = output_base_dir + "260223_myh8_sumproj/";
File.makeDirectory(myh8_sumproj_dir);

myh8_rois_dir = output_base_dir + "260223_myh8_rois/";
File.makeDirectory(myh8_rois_dir);

results_dir = output_base_dir + "260223_results/";
